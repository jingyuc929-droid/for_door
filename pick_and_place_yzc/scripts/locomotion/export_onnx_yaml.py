...
from isaaclab.utils.math import quat_apply, quat_apply_yaw, quat_inv, quat_rotate_inverse, transform_points, yaw_quat
...
def main():
    ...
    # 重新生成一份 policy.yaml（包含完整 joint_kp/joint_kd：腿+臂）
    # 说明：历史版本只写了 base_legs 的 12 维，导致像 grq20_v2d4_x5 的 18 关节导出不完整。
    export_inference_cfg_locomotion(
        env,
        env_cfg,
        log_dir,
        ...
        env_cfg.config_summary.env.RL_SIM_ENV_CONFIG_SUMMARY_DIR,
    )
