...
from rl_sim_env.envs import LocomotionRLEnv


class LocomotionVecEnvWrapper(VecEnv):
    ...
    def __init__(self, env: LocomotionRLEnv, clip_actions: float | None = None, clip_obs: float | None = None):
        ...
        if not isinstance(env.unwrapped, LocomotionRLEnv):
            raise ValueError(f"The environment must be inherited from LocomotionRLEnv. Environment type: {type(env)}")
    ...
    @property
    def unwrapped(self) -> LocomotionRLEnv:
    ...
    def get_observations(self) -> tuple[torch.Tensor, dict]:
        return self.unwrapped.obs_tensor_dict
