...
gym.register(
    id="Locomotion-GRQ20-V2D4-X5-Terrain-VAE",
...
gym.register(
    id="Locomotion-GRQ20-V2D4-X5-Terrain-VAE-Play",
    entry_point="rl_sim_env.envs:LocomotionRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="Locomotion-GRQ20-V2D4-X5-Terrain-ReplayAmpData",
    entry_point="rl_sim_env.envs:LocomotionRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.locomotion_env_cfg:"
            "LocomotionWholeBodyVaeEnvCfg_REPLAY_AMPDATA"
        ),
        "locomotion_cfg_entry_point": (
            f"{__name__}.config_summary:LocomotionWholeBodyPPORunnerCfg"
        ),
