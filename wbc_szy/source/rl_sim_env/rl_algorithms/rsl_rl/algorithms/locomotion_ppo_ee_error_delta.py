...
class LocomotionPPOEeErrorDelta:
    """LocomotionPPO + EE tracking-error delta VAE MSE supervision.

    与 LocomotionPPO 的唯一区别：VAE loss 多一项 EE error delta MSE
    （code_ee_error_delta vs gt_ee_error_delta_obs），adaboot gt_out 多拼
    gt_ee_error_delta_obs。code 拼接顺序 [vel,com,mass,ee_error_delta,latent]。
    """
    ...
    def update(self):  # noqa: C901
        ...
        if self.use_vae:
            ...
            mean_vae_com_loss = 0
            mean_vae_ee_error_delta_loss = 0
        ...
        for sample_step in data_generator:
            ...
            if self.use_vae:
                ...
                vae_ee_error_delta_target = obs_batch["gt_ee_error_delta_obs"].detach()
                ...
                loss_recon_ee_error_delta = nn.MSELoss()(
                    vae_out["code_ee_error_delta"],
                    vae_ee_error_delta_target,
                )
            ...
            if self.use_vae:
                ...
                mean_vae_ee_error_delta_loss += loss_recon_ee_error_delta.item()
        ...
        if self.use_vae:
            ...
            mean_vae_ee_error_delta_loss /= num_updates
            ...
            loss_debug_dict_vae = {
                ...
                "vae_ee_error_delta_loss": mean_vae_ee_error_delta_loss,
