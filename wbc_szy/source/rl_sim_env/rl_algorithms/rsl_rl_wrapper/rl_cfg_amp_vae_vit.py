...
class AmpVaeVitPpoActorCriticCfg:
    ...
    heightmap_encoder_dims: list[int] = MISSING
    """The hidden dimensions of the heightmap encoder network."""

    footheight_encoder_dims: list[int] = MISSING
    """The hidden dimensions of the footheight encoder network."""

    privileged_encoder_dims: list[int] = MISSING
    """The hidden dimensions of the privileged encoder network."""
...
class AmpVaeVitPpoAlgorithmCfg:
    ...
    vae_desired_loss: float = MISSING
    """The desired reconstruction loss for the VAE."""

    use_ground_truth: bool = False
    """Whether to use ground truth data for the VAE."""

    use_amp: bool = False
    """Whether to use AMP."""

    use_adaboot: bool = False
    """Whether to use AdaBoot."""
