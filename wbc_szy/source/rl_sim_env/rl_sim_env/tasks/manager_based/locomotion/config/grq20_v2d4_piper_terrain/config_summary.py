...
ROBOT_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            # 注意：piper 的 link3 关节方向与 X5 相反，需取负（参考 piper_default）；
            # 其余沿用 terrain 的占位姿态（link2=0.8），仅对 link3 翻号得到 -0.8。
            "link1_joint": 0.0,
            "link2_joint": 0.8,
            "link3_joint": -0.8,
            "link4_joint": 0.0,
...
class ConfigSummary:
    ...
    class reward:   
        ...
        config_dict = {
            ...
            'orientation_l2': {
                'weight': [-0.05, -0.05, -0.05, -0.05, -0.0, -0.0, -3.0]
            },
            'ang_vel_xy_l2': {
                # 'weight': -0.05
                'weight': -0.1
            ...
            #         # 在 [neutral_z_low, neutral_z_high] 内固定 pitch_target=neutral_pitch
            #         'neutral_z_low': 0.45,
            #         'neutral_z_high': 0.55,
            #         'neutral_pitch': 0.0,
    ...
    class command:
        ...
        ee_target_resampling_time_range = (20, 20)
        ...
        ee_target_pos_z_range = (-0.10, 0.5)
        ee_target_roll_range = (-1.1, 1.1)
        ee_target_pitch_range = (-1.1, 1.1)
...
class LocomotionWholeBodyPPORunnerCfg(LocomotionOnPolicyRunnerCfg):
    ...
    experiment_name = "grq20_v2d4_piper_terrain_locomotion"
    swanlab_project = "grq20_v2d4_piper_terrain_locomotion"
