...
class ConfigSummary:
    ...
    class env:
        ...
        # VAE 显式监督使用的末端 9D 跟踪误差变化值
        ee_target_points_error_delta_dim = 9
        ...
        num_estimator_out = 23 + ee_target_points_error_delta_dim
        ...
        policy_type = {
            ...
            'vae_type': "VAEBlindEeErrorDelta",
            'algo_type': "LocomotionPPOEeErrorDelta",
        }
        ...
        module_cfg_dict = {
            ...
            "vae": {
                ...
                'encoder_head_dim_dict': {
                    ...
                    'obs_com': 3,
                    'obs_mass': 1,
                    'obs_ee_error_delta': ee_target_points_error_delta_dim,
                    'obs_latent': 16,
                },
    ...
    class observation:
        obs_term_dict = {
            'ground_truth_obs': {
                ...
                'ee_target_points_error_delta_gt': {
                    'scale': 1.0,
                    'params': {
                        'command_name': 'ee_target_points',
                        'ee_asset_cfg': SceneEntityCfg("robot", body_names=ROBOT_EE_BODY_NAME),
        ...
        policy_obs_dict = {
            ...
            'gt_ee_error_delta_obs': {
                'terms': ['ee_target_points_error_delta_gt',
                          ],
            },
        }
...
class LocomotionWholeBodyPPORunnerCfg(LocomotionOnPolicyRunnerCfg):
    ...
    save_interval = 200
    experiment_name = "grq20_v2d4_piper_vae_de_locomotion"
    swanlab_project = "grq20_v2d4_piper_vae_de_locomotion"
