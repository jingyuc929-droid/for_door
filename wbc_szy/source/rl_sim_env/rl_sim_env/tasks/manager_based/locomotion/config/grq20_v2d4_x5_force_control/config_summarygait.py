...
# 末端 link 名与非 gait 配置保持一致（用于末端外力事件）
from .config_summary import ROBOT_EE_BODY_NAME
...
class ConfigSummary:
    ...
    class env:
        ...
        # privileged_obs dims: original 43 + ee_external_force(3) = 46
    ...
    class event:
        ...
        ee_force_x_range_max = (5.0, 5.0)
        ee_force_y_range_start = (0.0, 0.0)
        ee_force_y_range_max = (0.0, 0.0)
        ee_force_z_range_start = (0.0, 0.0)
        ee_force_z_range_max = (0.0, 0.0)
        ...
        ee_force_interval_range_s = (1.0, 1.0)
...
class LocomotionWholeBodyGaitPPORunnerCfg(LocomotionOnPolicyRunnerCfg):
    ...
    experiment_name = "grq20_v2d4_x5_force_control_wholebody_gait_locomotion"
    swanlab_project = "grq20_v2d4_x5_force_control_wholebody_gait_locomotion"
