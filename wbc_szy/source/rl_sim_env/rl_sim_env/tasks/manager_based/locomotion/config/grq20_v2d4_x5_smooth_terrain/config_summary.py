...
class ConfigSummary:
    ...
    class command:
        ...
        max_lin_x_level: float = 4.0
        ang_z_level: float = 0.0
        max_ang_z_level: float = 4.0
        ...
        # 地面基准模式(use_projected_origin=True)下的地面高度低通滤波系数
        # - 1.0: 不滤波
        # - 越小越平滑，但响应更慢
        ee_target_ground_z_lpf_alpha = 0.5
...
class LocomotionPPORunnerCfg(LocomotionOnPolicyRunnerCfg):
    ...
    experiment_name = "grq20_v2d4_x5_smooth_terrain_locomotion"
    swanlab_project = "grq20_v2d4_x5_smooth_terrain_locomotion"
