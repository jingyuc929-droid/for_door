...
class ConfigSummary:
    ...
    class command:
        ...
        max_lin_x_level: float = 2.0
        ang_z_level: float = 0.0
        max_ang_z_level: float = 2.0
...
@configclass
class LocomotionGaitPPORunnerCfg(LocomotionOnPolicyRunnerCfg):
    seed = 42
    device = "cuda:0"
    num_steps_per_env = 24
    max_iterations = 100000
    save_interval = [500, 1000, 2000, 3000, 5000, 7000, 10000, 15000, 20000, 30000, 50000, 70000, 100000]
    experiment_name = "grq20_v2d4_x5_smooth_terrain_gait_locomotion"
    swanlab_project = "grq20_v2d4_x5_smooth_terrain_gait_locomotion"
